...
Personal intelligence system — ingests Gmail, Limitless.ai lifelogs, and WhatsApp into Postgres, then uses Codex to synthesize projects and relationships.
...
│   ├── limitless/          Limitless.ai API → Codex processing
│   ├── projects/           Codex project discovery across all sources
│   ├── relationships/      Codex contact profiling + relationship graph
│   └── ai/                 Standalone AI agent (Codex / OpenAI / Gemini)
└── ui/
